...
export default function Filters() {
    ...
    return (
        <div className="flex justify-between items-center mb-4">
            <div>
                <span className="uppercase text-sm text-gray-500 mr-2">Filter by</span><Button.Group>
            ...
            <div>
                <span className="uppercase text-sm text-gray-500 mr-2">Order by</span> <Button>
            ...
            <div>
                <span className="uppercase text-sm text-gray-500 mr-2">Page size</span> <Button.Group>
