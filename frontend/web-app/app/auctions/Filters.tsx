...
export default function Filters() {
    ...
    return (
        <div className="flex justify-between items-center mb-4">
            <div>
                <span className="uppercase text-sm text-gray-500 mr-2">Filter by</span> <ButtonGroup>
            ...
            <div>
                ...
                <ButtonGroup> {/* ← Changed from <Button> to <Button.Group> */} {orderButtons.map(({
                                                                                                       label,
                                                                                                       icon: Icon,
                                                                                                       value
                                                                                                   }) => (
                ...
                </ButtonGroup> {/* ← Changed from </Button> to </Button.Group> */}
            </div>
            <div>
                <span className="uppercase text-sm text-gray-500 mr-2">Page size</span> <ButtonGroup>
